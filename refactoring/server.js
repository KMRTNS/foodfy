...
server.get('/', function(req, res) {
  return res.render('index', { dataset: recipes })
})
...
server.get('/about', function(req, res) {
  ...
  return res.render('about', { dataset: about })
})

server.get('/recipes', function(req, res) {
  return res.render('recipes', { dataset: recipes })
})
...
server.get('/recipes/:id', function(req, res) {
  ...
  return res.render('info', { dataset: recipes[id] })
})
